...
// SSL options
const options = {
    key: fs.readFileSync('/etc/letsencrypt/live/smartbrainsenvironments.online/privkey.pem'),
    cert: fs.readFileSync('/etc/letsencrypt/live/smartbrainsenvironments.online/fullchain.pem')
};
